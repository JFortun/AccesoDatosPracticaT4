...
public class Profesores extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("colegio.Profesores"));
     ...
     * @see #removeImparten
     */
    public final colegio.Clases[] getImparten() {
        return (colegio.Clases[])getSuccessors(getImpartenRelationship(getMtDatabase()), colegio.Clases.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> impartenIterator() {
        return this.<E>successorIterator(getImpartenRelationship(getMtDatabase()), colegio.Clases.class);
    }
     ...
     * @see #removeImparten
     */
    public final void setImparten(colegio.Clases[] succs) {
     ...
     * @see #removeImparten
     */
    public final void prependImparten(colegio.Clases succ) {
     ...
     * @see #impartenIterator
     */
    public final void appendImparten(colegio.Clases succ) {
     ...
     * @see #impartenIterator
     */
    public final void appendImparten(colegio.Clases[] succs) {
     ...
     * @see #impartenIterator
     */
    public void removeImparten(colegio.Clases[] succs) {
     ...
     * @see #impartenIterator
     */
    public void removeImparten(colegio.Clases succ) {
