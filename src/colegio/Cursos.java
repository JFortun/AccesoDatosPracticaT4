 ...
 */
public class Cursos extends colegio.Clases {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("colegio.Cursos"));
