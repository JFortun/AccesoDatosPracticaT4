 ...
 * Generation date: Tue Jan 12 16:07:42 2021
 */
...
public class Clases extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("colegio.Clases"));
     ...
     */
    public final colegio.Profesores[] getImpartidas_por() {
        return (colegio.Profesores[])getSuccessors(getImpartidas_porRelationship(getMtDatabase()), colegio.Profesores.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> impartidas_porIterator() {
        return this.<E>successorIterator(getImpartidas_porRelationship(getMtDatabase()), colegio.Profesores.class);
    }
     ...
     * @see #removeImpartidas_por
     */
    public final void setImpartidas_por(colegio.Profesores[] succs) {
     ...
     * @see #removeImpartidas_por
     */
    public final void prependImpartidas_por(colegio.Profesores succ) {
     ...
     * @see #impartidas_porIterator
     */
    public final void appendImpartidas_por(colegio.Profesores succ) {
     ...
     * @see #impartidas_porIterator
     */
    public final void appendImpartidas_por(colegio.Profesores[] succs) {
     ...
     * @see #impartidas_porIterator
     */
    public void removeImpartidas_por(colegio.Profesores[] succs) {
     ...
     * @see #impartidas_porIterator
     */
    public void removeImpartidas_por(colegio.Profesores succ) {
